<?php
/**
 * Clase para realizar el ADD en Estadistica
 *	autor: Carlos Mato Rodriguez
 *	15-06-2019
 */
	class Estadistica_ADD{
		...
		function render(){
            include '../Views/Header_View.php';?>
						...
						<div class="col-md-6 col-lg-3 contenido">
							<h1><?php echo $strings['Añadir Estadistica']; ?></h1>
							<form name = 'Form' enctype="multipart/form-data" action='../Controllers/Estadistica_Controller.php?accion=ADD' method='post' onsubmit="return comprobarRegistro(this)">
				<div class="bloque">
					<div class="campo">
			...
			<div class="campo">
				...
				<option value="Inactivo"><?php echo $strings['Inactivo']; ?></option>
					...
					<button class="form-btn" type="button" role="link" onclick="window.location='../Controllers/Estadistica_Controller?accion=SHOWALL.php';" ><i class="fas fa-times"></i></button>
						</form>
						</div>
					</div>
<?php
