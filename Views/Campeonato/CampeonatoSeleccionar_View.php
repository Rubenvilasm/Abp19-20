...
<div class="col-md-6 col-lg-3 contenido">
    <h1><?php echo $strings['Seleccione su pareja la categoria y el nivel para ver los grupos']; ?></h1>
    <form name='Form' enctype="multipart/form-data"
        action='../Controllers/Campeonato_Controller.php?accion=Seleccionar&param=<?php echo $datos;?>' method='post'
        ...
        <div class="bloque">
            ...
            <button class="form-btn" type="button" role="link"
                onclick="window.location='../Controllers/Campeonato_Controller.php?accion=Seleccionar';"><i
