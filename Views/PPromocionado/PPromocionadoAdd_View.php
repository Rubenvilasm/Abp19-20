            ...
            <div class="col-md-6 col-lg-3 contenido">
				...
				<div class="bloque">
					...
					<div class="campo">
						...
						<input type = 'text' name = 'idParticipante3' id = 'idParticipante3' placeholder = '<?php echo $strings['Participante 3']?>' size = '25' value = '' onblur="return comprobarAlfanum(this,25)" ><br>
						<p class="invalid" id="invalidParticipante"><?php echo $strings['Formato no válido'];?></p>
					</div>
					<div class="campo">
